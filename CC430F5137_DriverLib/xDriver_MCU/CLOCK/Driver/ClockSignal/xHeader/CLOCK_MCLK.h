...
#ifndef XDRIVER_MCU_CLOCK_DRIVER_CLOCKSIGNAL_XHEADER_CLOCK_MCLK_H_
#define XDRIVER_MCU_CLOCK_DRIVER_CLOCKSIGNAL_XHEADER_CLOCK_MCLK_H_
...
#endif /* XDRIVER_MCU_CLOCK_DRIVER_CLOCKSIGNAL_XHEADER_CLOCK_MCLK_H_ */
