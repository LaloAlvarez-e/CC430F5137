                                            ...
                                            TIMERA_nLEVEL enLevelArg)
{
    ...
    pstRegisterData.uxValue = (UBase_t) enLevelArg;
    pstRegisterData.uxMask = TIMERA_CC_CTL_OUT_MASK;
    pstRegisterData.uxShift = TIMERA_CC_CTL_R_OUT_BIT;
                                          ...
                                          TIMERA_nLEVEL* penLevelArg)
{
    ...
    if(TIMERA_enERROR_OK == enErrorReg)
    {
        *penLevelArg = (TIMERA_nLEVEL) pstRegisterData.uxValue;
    }
