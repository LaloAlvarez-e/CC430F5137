 ...
 ************************************ 1 CTL *********************************************
 ******************************************************************************************/
#define DMA_CH1_CTL_R  (*(volatile UBase_t*) (DMA_CH1_BASE + DMA_CH_CTL_OFFSET))
#define DMA_CH1_CTL    ((DMA_CH_CTL_t*) (DMA_CH1_BASE + DMA_CH_CTL_OFFSET))

/******************************************************************************************
 ************************************ 2 SA *********************************************
 ******************************************************************************************/
#define DMA_CH1_SA_R (*(volatile uintptr_t*) (DMA_CH1_BASE + DMA_CH_SA_OFFSET))
#define DMA_CH1_SA ((DMA_CH_SA_t*) (DMA_CH1_BASE + DMA_CH_SA_OFFSET))

/******************************************************************************************
 ************************************ 3 DA *********************************************
 ******************************************************************************************/
#define DMA_CH1_DA_R (*(volatile uintptr_t*) (DMA_CH1_BASE + DMA_CH_DA_OFFSET))
#define DMA_CH1_DA ((DMA_CH_DA_t*) (DMA_CH1_BASE + DMA_CH_DA_OFFSET))

/******************************************************************************************
 ************************************ 4 SZ *********************************************
 ******************************************************************************************/
#define DMA_CH1_SZ_R (*(volatile UBase_t*) (DMA_CH1_BASE + DMA_CH_SZ_OFFSET))
