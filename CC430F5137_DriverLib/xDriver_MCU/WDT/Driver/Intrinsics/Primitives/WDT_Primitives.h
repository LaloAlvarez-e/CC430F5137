...
#ifndef XDRIVER_MCU_WDT_DRIVER_INTRINSICS_PRIMITIVES_WDT_PRIMITIVES_H_
#define XDRIVER_MCU_WDT_DRIVER_INTRINSICS_PRIMITIVES_WDT_PRIMITIVES_H_
...
#endif /* XDRIVER_MCU_WDT_DRIVER_INTRINSICS_PRIMITIVES_WDT_PRIMITIVES_H_ */
