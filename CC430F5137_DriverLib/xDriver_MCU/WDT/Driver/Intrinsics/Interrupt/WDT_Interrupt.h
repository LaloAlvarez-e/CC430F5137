...
#ifndef XDRIVER_MCU_WDT_DRIVER_INTRINSICS_INTERRUPT_WDT_INTERRUPT_H_
#define XDRIVER_MCU_WDT_DRIVER_INTRINSICS_INTERRUPT_WDT_INTERRUPT_H_
...
#endif /* XDRIVER_MCU_WDT_DRIVER_INTRINSICS_INTERRUPT_WDT_INTERRUPT_H_ */
