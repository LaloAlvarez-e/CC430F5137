...
#ifndef XDRIVER_MCU_WDT_DRIVER_INTRINSICS_WDT_INTRINSICS_H_
#define XDRIVER_MCU_WDT_DRIVER_INTRINSICS_WDT_INTRINSICS_H_
...
#endif /* XDRIVER_MCU_WDT_DRIVER_INTRINSICS_WDT_INTRINSICS_H_ */
