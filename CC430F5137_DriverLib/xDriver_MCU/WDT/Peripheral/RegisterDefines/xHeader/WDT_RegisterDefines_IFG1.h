 ...
 ******************************************************************************************/
/*-----------*/
#define WDT_IFG1_R_IFG_BIT ((UBase_t) 0U)

#define WDT_IFG1_IFG_MASK ((UBase_t) 0x01U)
#define WDT_IFG1_IFG_NOOCCUR ((UBase_t) 0x00U)
#define WDT_IFG1_IFG_OCCUR ((UBase_t) 0x01U)
