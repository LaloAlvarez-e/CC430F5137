...
AES_nERROR AES__enSetInterruptSourceState(AES_nSTATE enStateArg)
{
    ...
    stRegister.uptrAddress = AES_IE1_OFFSET;
    stRegister.uxValue = (UBase_t) enStateArg;
    stRegister.uxMask = (UBase_t) AES_IE1_IE_MASK;
    stRegister.uxShift = (UBase_t) AES_IE1_R_IE_BIT;
...
AES_nERROR AES__enGetInterruptSourceState(AES_nSTATE* penStateArg)
{
    ...
    {
        stRegister.uxShift = AES_IE1_R_IE_BIT;
        stRegister.uxMask = (uint8_t) AES_IE1_IE_MASK;
        stRegister.uptrAddress = AES_IE1_OFFSET;
